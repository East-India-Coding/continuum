...
import 'package:continuum/application/user_service.dart';
...
import 'package:continuum/presentation/widgets/animated_background.dart';
import 'package:continuum/presentation/widgets/continuum_header.dart';
...
class _SignInPageState extends ConsumerState<SignInPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final controller = ref.read(userServiceProvider);

    Future<void> onSkip() async {
      final userCred = await authService.signInAnonymously();
      await controller.handleSignin(user: userCred.user);
    }
