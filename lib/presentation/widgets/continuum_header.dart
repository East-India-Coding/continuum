...
import 'package:continuum/constants.dart';
...
import 'package:continuum/presentation/widgets/hover_link_text.dart';
...
class ContinuumHeader extends ConsumerWidget {
  const ContinuumHeader({super.key});
                    ...
                    showDialog<void>(
                      ...
                      builder: (context) => ContinuumDialog(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              '''Continuum is a knowledge engine that extracts structured knowledge from podcasts and organizes it into an interactive graph. Each idea is connected, source-grounded, and queryable, turning passive listening into a durable, explorable knowledge system.''',
                            ...
                            InkWell(
                              onTap: () async {
                                UrlLauncher.launchURLNewTab(
                                  ContinuumConstants.continuumYtLink,
                                );
                              },
                              child: const Row(
                                children: [
              ...
              IconButton(
                ...
                icon: Icon(
                  ...
                  color: isMusicPlaying
                      ? ContinuumColors.accent
                      : ContinuumColors.textGrey,
                ),
                tooltip: isMusicPlaying ? 'Stop Music' : 'Play Music',
              ),
              Builder(
                builder: (context) {
                  final userProfileValue = ref.watch(authStateChangesProvider);
  ...
  Widget _buildProfileSection(
    ...
    return PopupMenuButton(
      ...
      color: ContinuumColors.secondary,
      shape: RoundedRectangleBorder(
        side: const BorderSide(color: ContinuumColors.accent),
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: userInfo.photoURL != null
                    ? DecorationImage(
                        image: NetworkImage(userInfo.photoURL.toString()),
                        fit: BoxFit.cover,
                      )
                    : null,
              ),
            ...
            const SizedBox(width: 12),
            Text(
              userInfo.displayName?.toUpperCase() ?? 'USER',
